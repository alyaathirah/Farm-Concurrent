...
//            System.out.println(plants[i]);
    ...
    synchronized void getJob(int userid){//later set to synchronized in concurrent
        ...
        if(tempStatus==0 || tempStatus==3 ||tempStatus==4) {//plant related
            ...
            tempType = "none";
        //push to database
        Seeder.seedActivity(tempAction, tempType, tempUnit, String.valueOf(tempQuantity), String.valueOf(tempField), String.valueOf(tempRow), String.valueOf(farmid), String.valueOf(userid));
    }
}
